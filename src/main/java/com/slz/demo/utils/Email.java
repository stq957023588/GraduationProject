...
public class Email {
    ...
    private Email(String smtpHost, String sendUserName, String sendUserPass, String to,String mailSubject, String mailBody) {
        this.smtpHost = smtpHost;
        this.sendUserName = sendUserName;
        this.sendUserPass = sendUserPass;
        init();
    ...
    public static Email noAttatachmentEntity(String smtpHost,String sendUserName,String sendUserPass,String to,String mailSubject,String mailBody){
        return new Email(smtpHost,sendUserName,sendUserPass,to,mailSubject,mailBody);
    }
